...
export const GameExisting: Game[] = [
  ...
  { "id": 6,"uuid":"e822ef82-8c68-478c-b5d8-874accb3105b", "name": "Skull King", "scorePlusEleve": true, "scoreLimite": 0, "mancheLimite": 10, "scoreNegatif": true, "canEdit": false, "minJoueur": 2, "maxJoueur": 10, "sheet": "skullKing", "specificConf":"{\"rascalScore\":false,\"alwaysScore\":false,\"rascalPoing\":false,\"extension\":false,\"manche\":[2,3,1,4,5,6,7,8,9,10]}"},
